...
| ------ | ------ |
| [copyToClipboard](functions/copyToClipboard.md) | 复制文本到剪贴板 |
| [addClass](functions/addClass.md) | 向元素添加一个或多个 CSS 类 |
| [removeClass](functions/removeClass.md) | 从元素中移除一个或多个 CSS 类 |
| [toggleClass](functions/toggleClass.md) | 切换元素的 CSS 类(存在则移除,不存在则添加) |
| [createElement](functions/createElement.md) | 创建 DOM 元素,可指定属性和子元素 |
| [on](functions/on.md) | 事件绑定 在指定的元素上绑定事件监听器 |
| [off](functions/off.md) | 事件解绑 移除元素上的事件监听器 |
| [once](functions/once.md) | 一次性事件监听 绑定一个只触发一次的事件监听器，触发后自动移除 |
| [$](functions/$.md) | DOM 工具模块 提供常用的 DOM 操作功能 |
| [$$](functions/$$.md) | DOM 工具模块 提供常用的 DOM 操作功能 |
| [getStyle](functions/getStyle.md) | 获取元素指定 CSS 属性的计算值 |
